...
export const projects: Project[] = [
  {
    ...
    gallery: [
      { src: "/projects/ve-hr/employee-profile.png", alt: "VE HR — AI-parsed employee profile with competency map", width: 1920, height: 1563 },
      { src: "/projects/ve-hr/goals.png", alt: "VE HR — OKR and goal tracking", width: 1920, height: 1178 },
      { src: "/projects/ve-hr/policy-assistant.png", alt: "VE HR — AI policy assistant chat", width: 1920, height: 1082 },
    ],
    technologies: ["Next.js", "TypeScript", "MongoDB", "OpenAI API", "Tailwind CSS"],
    liveUrl: "https://hr-five-pi.vercel.app",
    githubUrl: "",
    featured: true,
  },
  {
    ...
    gallery: [
      { src: "/projects/gotrip/member-portal.png", alt: "GoTrip — member portal with VIP status and AI concierge chat", width: 1920, height: 1910 },
      { src: "/projects/gotrip/dispatch-journal.png", alt: "GoTrip — The Dispatch editorial travel journal", width: 1920, height: 3407 },
      { src: "/projects/gotrip/vanguard-about.png", alt: "GoTrip — The Vanguard team and company story page", width: 1920, height: 3903 },
      { src: "/projects/gotrip/vanguard-admin.png", alt: "GoTrip — Vanguard admin dashboard with AI content automation and publishing logs", width: 1920, height: 1067 },
    ],
    technologies: ["Next.js", "TypeScript", "PostgreSQL", "OpenAI API", "Tailwind CSS"],
  ...
  },
  {
    ...
    gallery: [
      { src: "/projects/libya-logistics/login.png", alt: "Libya Logistics — sign-in with role-based demo quick-login", width: 1920, height: 895 },
      { src: "/projects/libya-logistics/warehouses.png", alt: "Libya Logistics — warehouse directory across Libyan hubs", width: 1920, height: 2020 },
      { src: "/projects/libya-logistics/shipment-detail.png", alt: "Libya Logistics — shipment detail with full movement history audit trail", width: 1920, height: 1787 },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: "/projects/aigramx/login.png", alt: "AIGramX — sign in screen", width: 1920, height: 942 },
      { src: "/projects/aigramx/settings.png", alt: "AIGramX — theme and notification settings with live preview", width: 1920, height: 2076 },
    ],
